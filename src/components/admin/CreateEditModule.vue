  ...
  <div class="modal-card" style="with: auto">
    ...
    <footer class="modal-card-foot">
      <b-button
        ...
        @click.native="createModule ? addModule() : updateModule()"
      />
...
@Component
export default class CreateEditModule extends Vue {
  ...
  async addModule(): Promise<void> {
    try {
      (await Vue.axios.post("/module", this.module)).data;
    } catch (e) {
      console.error(e);
      return;
    }
  ...
  async updateModule(): Promise<void> {
    try {
      (await Vue.axios.put(`/module/${this.module.moduleNo}`, this.module))
        .data;
    } catch (e) {
      console.error(e);
      return;
